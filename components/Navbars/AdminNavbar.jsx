					...
					<form className="mr-3 hidden flex-row flex-wrap items-center md:flex lg:ml-auto">
						<div className="relative flex w-full flex-wrap items-stretch">
							...
							<input
								...
								className="placeholder:text-blueGray-300 text-blueGray-600 relative w-full rounded border-0 bg-white p-3 pl-10 text-sm shadow outline-none focus:outline-none focus:ring"
							/>
						</div>
					</form>
					{/* User */}
